...
速度测试
python test.py --weights runs/exp0/weights/best.pt --data trafficLight12.yaml --batch-size 1 --device 0

使用
python detect.py --weights runs/exp0/weights/best.pt --source inference/images/
